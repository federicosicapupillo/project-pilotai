...
function normalizeIdeas(value: unknown, data: z.infer<typeof InputSchema>) {
  ...
  return ideas.map((idea, index) => ({
    ...
    suggested_price: idea.suggested_price || "29€/mese",
    earning_range: idea.earning_range || "300€ – 1.000€/mese",
    scenario_prudent: idea.scenario_prudent || "10 clienti x 29€/mese = 290€/mese",
    scenario_realistic: idea.scenario_realistic || "30 clienti x 29€/mese = 870€/mese",
    scenario_high: idea.scenario_high || "70 clienti x 29€/mese = 2.030€/mese (solo se validato)",
    break_even: idea.break_even || "Calcolo: costo iniziale / prezzo mensile = numero clienti necessari per rientrare.",
    commercial_risk: idea.commercial_risk || "Medio",
    earning_explanation: idea.earning_explanation || "Stima prudente: il risultato reale dipende da prezzo, acquisizione e qualità del prodotto.",
