...
const it: Dict = {
  ...
  "cta.early.micro": "Early access: 29€ per 12 mesi. Nessun pacchetto crediti. Il prezzo salirà più avanti.",
...
const en: Dict = {
  ...
  "cta.early.micro": "Early access: €29 for 12 months. No credit packs. Price will increase later.",
