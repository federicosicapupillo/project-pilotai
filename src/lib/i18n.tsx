...
const it: Dict = {
  ...
  "home.ex.1.t": "Prenotazioni per ristorante",
  "home.ex.1.d": "Una web app semplice per ricevere prenotazioni senza più perdere chiamate.",
  ...
  "home.ex.4.t": "Gestionale per agente immobiliare",
  "home.ex.4.d": "Annunci, clienti interessati, appuntamenti in un posto solo.",
  ...
  "home.target.list.1": "Ristoratori e attività locali",
  "home.target.list.2": "Agenti immobiliari",
  ...
  "pricing.accessNote": "Accesso iniziale al Team IA operativo per trasformare la tua idea nella prima versione dell'app.",
...
const en: Dict = {
  ...
  "home.ex.1.t": "Restaurant bookings",
  "home.ex.1.d": "A simple web app to receive reservations without missing calls.",
  ...
  "home.ex.4.t": "Real-estate agent tool",
  "home.ex.4.d": "Listings, interested clients and appointments in one place.",
  ...
  "home.target.list.1": "Restaurants and local businesses",
  "home.target.list.2": "Real-estate agents",
  ...
  "pricing.accessNote": "Initial access to the operational AI Team to turn your idea into the first version of the app.",
  "pricing.early": "Early access",
